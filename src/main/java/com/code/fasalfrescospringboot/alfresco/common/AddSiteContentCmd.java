...
public class AddSiteContentCmd {
    ...
    private Node createFolder(String parentFolderId,
        ...
        Node folderNode = Objects.requireNonNull(nodesApi.createNode(parentFolderId, nodeBodyCreate, autoRename, majorVersion, versioningEnabled,
